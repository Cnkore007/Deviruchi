...
fn test_login_log_event_types() {
    ...
    manager.log_event(1, "user1".to_string(), "192.168.1.1".to_string(), LoginEvent::LoginSuccess, "成功".to_string());
    manager.log_event(2, "user2".to_string(), "192.168.1.2".to_string(), LoginEvent::LoginFailed, "密码错误".to_string());
    manager.log_event(3, "user3".to_string(), "192.168.1.3".to_string(), LoginEvent::Banned, "账号封禁".to_string());
...
fn test_char_log_all_events() {
    ...
    manager.log_event(1001, 1, "角色1".to_string(), CharLogEvent::CharCreate, "创建".to_string());
    manager.log_event(1001, 1, "角色1".to_string(), CharLogEvent::CharOnline, "上线".to_string());
    manager.log_event(1001, 1, "角色1".to_string(), CharLogEvent::CharOffline, "下线".to_string());
    manager.log_event(1001, 1, "角色1".to_string(), CharLogEvent::CharDelete, "删除".to_string());
...
fn test_char_log_rename() {
    ...
    manager.log_event(1001, 1, "旧名字".to_string(), CharLogEvent::CharRename, "改名为新名字".to_string());
