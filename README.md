...
> **90,000+ 行 Rust 代码，295 个源文件，1,322 测试（全部通过），覆盖 61 个服务端模块 + Devi 客户端 + DeviAgent。
...
| **skill** | 1,300+ 行 | 技能处理器（冷却/消耗/范围检查）、技能效果系统、技能效果执行器、技能树系统（6 职业）、支持 33 个技能 ID，42 测试 |
...
| **script** | 2,400+ 行 | 脚本解析器（30 个命令）、表达式解析、函数调用栈、循环控制、背包/HP/广播/NPC变量集成、98 测试 |
