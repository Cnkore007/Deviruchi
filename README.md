...
> **65,000+ 行** Rust 代码，229 个源文件，1,000+ 单元测试，覆盖 42 个游戏子系统 + Devi 客户端，整体完成度 **~95%**。
...
| **mob** | 2,800+ 行 | 六状态 AI 状态机、A* 寻路、掉落表、MVP 判定、rAthena YAML 完整解析（Race/Class/Modes/Skills/MvpDrops），46 测试 |
...
### 客户端 (Devi) — 4,500+ 行，38 个源文件，80 个测试
