...
mod tests {
    ...
    fn create_test_player() -> Player {
        Player {
            ...
            hp: parking_lot::RwLock::new(100),
            max_hp: parking_lot::RwLock::new(100),
            sp: parking_lot::RwLock::new(50),
            max_sp: parking_lot::RwLock::new(50),
            base_level: parking_lot::RwLock::new(10),
            job_level: parking_lot::RwLock::new(5),
            base_exp: parking_lot::RwLock::new(5000),
            job_exp: parking_lot::RwLock::new(3000),
            state: parking_lot::RwLock::new(PlayerState::Alive),
            str: parking_lot::RwLock::new(1),
            agi: parking_lot::RwLock::new(1),
            vit: parking_lot::RwLock::new(1),
            int: parking_lot::RwLock::new(1),
            dex: parking_lot::RwLock::new(1),
            luk: parking_lot::RwLock::new(1),
